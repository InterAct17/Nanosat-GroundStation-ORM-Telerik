...
{
    public partial class ValueAliasForm : Form
    {
        AliasManager d = new AliasManager();
        int aliasGroupId;
        public ValueAliasForm(int aliasGroupId)
        {
           
            InitializeComponent();
            this.aliasGroupId = aliasGroupId;
            valueAliasFlexGrid.DataSource = d.getValueAliasDataTableByGroupId(this.aliasGroupId);
        }
